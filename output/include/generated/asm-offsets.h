...
#define TSK_ACTIVE_MM 880 /* offsetof(struct task_struct, active_mm)	// */
...
#define THREAD_CPU_CONTEXT 2064 /* offsetof(struct task_struct, thread.cpu_context)	// */
...
#define CPU_CTX_SP 80 /* offsetof(struct cpu_suspend_ctx, sp)	// */
...
#define SLEEP_STACK_DATA_CALLEE_REGS 96 /* offsetof(struct sleep_stack_data, callee_saved_regs)	// */
